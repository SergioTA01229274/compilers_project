...
def p_statement_declare_and_assign_int(p):
    'statement : IDEC NAME ASSIGN expression'
...
def p_statement_declare_and_assign_float(p):
    'statement : FDEC NAME ASSIGN expression'
    names[p[2]] = {"type":"FLOAT","value":p[4]}
